...
# Exporting targets
# -----------------------------------------------------------------------------
set(PACKAGE_TARGETS_FILENAME sup-di-targets.cmake)
...
install(EXPORT sup-di-targets FILE ${PACKAGE_TARGETS_FILENAME} NAMESPACE sup-di:: DESTINATION ${INSTALL_CONFIGDIR})

# Generate the export targets for the build tree usage
export(TARGETS sup-di NAMESPACE sup-di:: FILE ${PACKAGE_TARGETS_FILE})
...
# -----------------------------------------------------------------------------
set(PACKAGE_VERSION_FILE ${BUILD_CONFIGDIR}/sup-di-config-version.cmake)
...
# -----------------------------------------------------------------------------
set(PACKAGE_CONFIG_FILE ${BUILD_CONFIGDIR}/sup-di-config.cmake)

# Generate the package config file, shared in both build tree and installation usage
write_package_config_file(sup-di OUTPUT ${PACKAGE_CONFIG_FILE} INSTALL_DESTINATION ${INSTALL_CONFIGDIR})
